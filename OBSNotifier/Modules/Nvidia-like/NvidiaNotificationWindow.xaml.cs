...
namespace OBSNotifier.Modules.NvidiaLike
{
    public partial class NvidiaNotificationWindow : Window
    {
        ...
        void UpdateParameters()
        {
            ...
            Height = Math.Ceiling(default_window_height * currentParams.Scale) + (fileOpen_viewbox.Visibility == Visibility.Visible ? Math.Ceiling(fileOpen_viewbox.Height + fileOpen_sep.Height) : 0);
